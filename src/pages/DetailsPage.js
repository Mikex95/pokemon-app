		...
		<section className="details-page">
			...
			<div className="pokemon-img__container">
				<div className="pokemon-img__box">
					<img src={pokeDetails.sprites.other.home.front_shiny} alt="pokemon" className="pokemon-img__img" />
				</div>
			</div>
			...
			<div className="details-grid">
				...
				<div className="wrapper-properties">
					<div className="details-type-container">{pokeDetails.types.map((elt) => {
						return <p className="types-properties">{elt.type.name}</p>
					})} </div>
